...
- technology
---
In this post, we'll cover the basic components of an IoT backend using an API Gateway to sustainably build a backend to your IoT applications. We'll provide new concepts, as well as helpful tips to get you off to a great start. 
